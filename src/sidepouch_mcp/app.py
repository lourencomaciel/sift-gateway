"""Compose the SidePouch application stack.
...
from sidepouch_mcp.lifecycle import CheckResult, run_startup_check
from sidepouch_mcp.mcp.server import GatewayServer, bootstrap_server

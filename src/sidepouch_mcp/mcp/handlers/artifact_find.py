...
from sidepouch_mcp.query.where_dsl import WhereDslError, evaluate_where
from sidepouch_mcp.query.where_hash import where_hash
from sidepouch_mcp.retrieval.response import apply_output_budgets
...
async def handle_artifact_find(
    ...
    Returns:
        ...
        error.
    """
    from sidepouch_mcp.tools.artifact_describe import FETCH_ROOTS_SQL

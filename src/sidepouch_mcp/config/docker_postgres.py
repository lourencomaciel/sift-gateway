...
When ``sidepouch-mcp init`` detects no explicit Postgres DSN, it calls
...
``sidepouch-mcp`` invocations connect automatically.
"""
...
VOLUME_NAME = "sidepouch-mcp-pgdata"
IMAGE = "postgres:16-alpine"
DEFAULT_DB = "sidepouch"
DEFAULT_USER = "sidepouch"
DEFAULT_PORT = 5432

"""Handler functions for MCP gateway tools."""

from mcp_artifact_gateway.mcp.handlers.artifact_chain_pages import handle_artifact_chain_pages
from mcp_artifact_gateway.mcp.handlers.artifact_describe import handle_artifact_describe
...
from mcp_artifact_gateway.mcp.handlers.artifact_search import handle_artifact_search
from mcp_artifact_gateway.mcp.handlers.artifact_select import handle_artifact_select
